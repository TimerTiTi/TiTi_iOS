...
extension ColorSelectorVC {
    ...
    private func fetchColor() {
        ...
        case .timer:
            ...
            let isWhite = UserDefaultsManager.get(forKey: .timerTintColorIsWhite) as? Bool ?? true
        ...
        case .stopwatcch:
            ...
            let isWhite = UserDefaultsManager.get(forKey: .stopwatchTintIsWhite) as? Bool ?? true
            self.textTintColor = isWhite ? .white : .black
        }
