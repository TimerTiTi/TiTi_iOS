...
enum Fonts {
    static func HGGGothicssiP00g(size: CGFloat) -> Font {
        return Font.custom("HGGGothicssiP00g", size: size)
    }
    static func HGGGothicssiP20g(size: CGFloat) -> Font {
        return Font.custom("HGGGothicssiP20g", size: size)
    }
    ...
    static func MiSansThin(size: CGFloat) -> Font {
        return Font.custom("MiSans-Thin", size: size)
    }
    static func MiSansExtraLight(size: CGFloat) -> Font {
        return Font.custom("MiSans-ExtraLight", size: size)
    }
    static func MiSansLight(size: CGFloat) -> Font {
        return Font.custom("MiSans-Light", size: size)
    }
    static func MiSansMedium(size: CGFloat) -> Font {
        return Font.custom("MiSans-Medium", size: size)
    }
    static func MiSansDemibold(size: CGFloat) -> Font {
        return Font.custom("MiSans-Demibold", size: size)
    }
    static func MiSansSemibold(size: CGFloat) -> Font {
        return Font.custom("MiSans-Semibold", size: size)
    }
    static func MiSansBold(size: CGFloat) -> Font {
        return Font.custom("MiSans-Bold", size: size)
    }
    static func MiSansHeavy(size: CGFloat) -> Font {
        return Font.custom("MiSans-Heavy", size: size)
    }
}

// MARK: UIFont
extension Fonts {
    static func HGGGothicssiP00g(size: CGFloat) -> UIFont? {
        return UIFont(name: "HGGGothicssiP00g", size: size)
    }
    static func HGGGothicssiP20g(size: CGFloat) -> UIFont? {
        return UIFont(name: "HGGGothicssiP20g", size: size)
    }
    ...
    static func MiSansThin(size: CGFloat) -> UIFont? {
        return UIFont(name: "MiSans-Thin", size: size)
    }
    static func MiSansExtraLight(size: CGFloat) -> UIFont? {
        return UIFont(name: "MiSans-ExtraLight", size: size)
    }
    static func MiSansLight(size: CGFloat) -> UIFont? {
        return UIFont(name: "MiSans-Light", size: size)
    }
    static func MiSansMedium(size: CGFloat) -> UIFont? {
        return UIFont(name: "MiSans-Medium", size: size)
    }
    ...
    static func MiSansHeavy(size: CGFloat) -> UIFont? {
        return UIFont(name: "MiSans-Heavy", size: size)
    }
}
