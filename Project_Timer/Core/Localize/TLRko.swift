...
struct TLRko {
    static func value(key: TLRkey, op: String? = nil) -> String {
        ...
        case .SignUp_Error_WrongEmailFormat: value = "잘못된 이메일 형식이에요."
        ...
        case .SignUp_Error_PasswordFormat: value = "8-64자 이내로 입력해주세요."
        case .SignUp_Error_PasswordMismatch: value = "비밀번호가 일치하지 않아요."
        ...
        case .SignUp_Error_WrongNicknameFormat: value = "1-12자 이내로 입력해주세요."
